...
const Simpsones = () => {
    const simpsones = [
...
},
        {
            ...
            image:'https://w7.pngwing.com/pngs/947/5/png-transparent-maggie-simpson-lisa-simpson-homer-simpson-bart-simpson-marge-simpson-homero-television-springfield-cartoon.png'

},
    ]
    return (
        <div>
            {simpsones.map(simpson=>
                <Simpson key={simpson.id} name = {simpson.name} description = {simpson.description} image = {simpson.image}
                />)}
        </div>
